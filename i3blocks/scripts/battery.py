...
formatinit = "<span background=\"#38253d\""
formatcolor = " foreground=\"#c98acf\">"
formatend = " </span>"
#def run(arg):
...
def get_battery():
    ...
    if "until" in raw:
        ...
        if   percent <= 5:   icon = BATTERY_CRITICAL; formatcolor = "foreground=\"#ff0000\">"
...
print(str(formatinit + formatcolor + get_battery() + formatend))
