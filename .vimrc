...
" Python
call s:HL('pythonDecorator', s:annotation, s:none)
call s:HL('pythonInclude', s:key1, s:none)
call s:HL('pythonImport', s:key1, s:none)
call s:HL('pythonBoolean', s:key2, s:none)
call s:HL('pythonFunction', s:fg, s:none)
call s:HL('pythonBuiltin', s:key2, s:none)
call s:HL('pythonStatement', s:key1, s:none)
...
hi SpellErrors cterm=bold ctermfg=7 ctermbg=0 gui=undercurl,bold
